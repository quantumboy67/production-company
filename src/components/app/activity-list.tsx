...
function formatAction(action: string) {
  const labels: Record<string, string> = {
    ...
    "revenue_item.restored": "Revenue item restored",
    "ticket_tier.created": "Ticket tier created",
    "ticket_tier.updated": "Ticket tier updated",
    "ticket_tier.deleted": "Ticket tier archived",
    "ticket_tier.restored": "Ticket tier restored",
